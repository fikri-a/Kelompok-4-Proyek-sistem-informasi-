 ...
 include 'koneksi.php';
  ...
  if (isset($_POST['bhapus'])) {
    $hapus = mysqli_query($koneksi, "DELETE FROM tb_pengujung WHERE id='$kd_id'");
...
<h2 class="m-0">Penghapusan data</h2>
    <!-- Right navbar links -->
              ...
              <form method="POST" action="" class="form-horizontal">
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="tNama" placeholder="<?php echo $Nama;?>">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="tAngkatan" class="col-sm-2 col-form-label">Angkatan</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="tAngkatan" placeholder="<?php echo $Angkatan;?>">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="tKunjungan" class="col-sm-2 col-form-label">Kunjungan</label>
                    <div class="col-sm-10">
                      <input type="" class="form-control" name="tKunjungan" placeholder="<?php echo $Kunjungan;?>">
                    </div>
                  </div>
