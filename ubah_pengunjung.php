 ...
 include 'koneksi.php';
  ...
  $kd_id = $_GET['kd'];
  $hasil = mysqli_query($koneksi, "SELECT * FROM tb_pengujung WHERE id='$kd_id'");
  ...
  $Kunjungan = $data[3];
    ...
    $hapus = mysqli_query($koneksi, "UPDATE tb_pengujung SET nama='$a', angkatan='$b', kunjungan='$c' WHERE id=$kd_id");
...
<h2 class="m-0">Perubahan data</h2>
    <!-- Right navbar links -->
              ...
              <form method="POST" action="" class="form-horizontal">
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="tNama" placeholder="nama baru">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="tAngkatan" class="col-sm-2 col-form-label">Angkatan</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="tAngkatan" placeholder="angkatan baru">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="tKunjungan" class="col-sm-2 col-form-label">Kunjungan</label>
                    <div class="col-sm-10">
                      <input type="datetime-local" class="form-control" name="tKunjungan" placeholder="">
                    </div>
                  </div>
                ...
                <div class="card-footer">
                  <a href="pengunjung.php" button type="submit" class="btn btn-primary">Batal</a>
                 
                  <button type="submit" name="bubah" class="btn btn-danger">Update</button>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
